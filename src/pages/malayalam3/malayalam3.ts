...
@IonicPage()
@Component({
  selector: 'page-malayalam3',
  templateUrl: 'malayalam3.html',
})
export class Malayalam3Page {

	storageDirectory: string = '';

	video: any = {
            url: 'https://www.youtube.com/embed/vBcTIpGHnPQ',
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad Malayalam3Page');
  }
