...
@IonicPage()
@Component({
  selector: 'page-malayalam1',
  templateUrl: 'malayalam1.html',
})
export class Malayalam1Page {

storageDirectory: string = '';

	video: any = {
            url: 'https://www.youtube.com/embed/7v9z7AnE_-k',
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad Malayalam1Page');
  }
