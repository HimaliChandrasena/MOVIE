...
@IonicPage()
@Component({
  selector: 'page-hollywood4',
  templateUrl: 'hollywood4.html',
})
export class Hollywood4Page {

	storageDirectory: string = '';

	video: any = {
            url: 'https://www.youtube.com/embed/uQaaYFrLwZQ',
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad Hollywood4Page');
  }
