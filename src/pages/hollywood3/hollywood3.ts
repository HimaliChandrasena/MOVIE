...
@IonicPage()
@Component({
  selector: 'page-hollywood3',
  templateUrl: 'hollywood3.html',
})
export class Hollywood3Page {

	storageDirectory: string = '';

	video: any = {
            url: 'https://www.youtube.com/embed/lvs8e8mFQqA',
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad Hollywood3Page');
  }
