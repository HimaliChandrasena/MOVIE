...
@IonicPage()
@Component({
  selector: 'page-malayalam4',
  templateUrl: 'malayalam4.html',
})
export class Malayalam4Page {

	storageDirectory: string = '';

	video: any = {
            url: 'https://www.youtube.com/embed/3C5aMGoevuw',
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad Malayalam4Page');
  }
