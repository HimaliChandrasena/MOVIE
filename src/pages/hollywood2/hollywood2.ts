...
@IonicPage()
@Component({
  selector: 'page-hollywood2',
  templateUrl: 'hollywood2.html',
})
export class Hollywood2Page {

storageDirectory: string = '';

	video: any = {
            url: 'https://www.youtube.com/embed/UgRgip-8Ujg',
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad Hollywood2Page');
  }
